...
<body>
    ...
    <br>
    <br>
<div class="container mx-auto px-200">


    <a class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow" href="add-product"> Add Product</a>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
           <c:forEach items="${products }" var="p">
            <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <a href="delete/${p.id}"><i class="fas fa-trash-alt text-red-600" style="font-size:20px"></i></a>
	            <a href="update/${p.id}"><i class="fas fa-pen text danger" style="font-size:20px"></i></a>
              </td>
            </tr>
